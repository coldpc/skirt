...
(function($, window, document, undefined) {
	...
	var Scroll = $.Class.extend({
		...
		_drag: function(e) {
			...
			if (!this.moved) {
				this.scroller.classList.add("scroller-drag-start");
		...
		_flick: function(e) {
			...
			if (!this.moved) {
				...
				this.scroller.classList.remove("scroller-drag-start");
			}
		...
		_updateTranslate: function() {
		    var _self = this;
		    console.log("has request animate");
			requestAnimationFrame(function() {
                _self.renderPosition(_self.x, _self.y);
			});
		},
		...
		_getTranslateStr: function(x, y) {
			if (this.options.hardwareAccelerated) {
				return 'translate3d(' + x + 'px,' + y + 'px,1px) ' + this.translateZ;
			}
...
(function($, window, document, name) {
	...
	$.createMask = function(callback, preventClose) {
		var element = document.createElement('div');
		element.classList.add(CLASS_BACKDROP);
		element.addEventListener($.EVENT_MOVE, $.preventDefault);
